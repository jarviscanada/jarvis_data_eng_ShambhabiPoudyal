...
public class CustomerDAO extends DataAccessObject<Customer> {
  ...
  public Customer findById(long id) {
    ...
    try(PreparedStatement statement = this.connection.prepareStatement(GET_ONE);) {
      ...
      logger.error("ERROR: SQL operation for findByID", e);
  ...
  public Customer update(Customer dto) {
    ...
    try{
      ...
      logger.error("ERROR: Updating prepared statement", e);
      throw new RuntimeException(e);
    }
    try(PreparedStatement statement = this.connection.prepareStatement(UPDATE);) {
      ...
      try {
        ...
        logger.error("ERROR: transaction rollback", sqle);
        throw new RuntimeException(sqle);
      }
      logger.error("ERROR: commit transaction", e);
      throw new RuntimeException(e);
    }
    return customer;
  }
  ...
  public Customer create(Customer dto) {
    try(PreparedStatement statement = this.connection.prepareStatement(INSERT);) {
      ...
      logger.error("ERROR: Inserting prepared statement", e);
      throw new RuntimeException(e);
    }
  }
  ...
  public void delete(long id) {
    try(PreparedStatement statement = this.connection.prepareStatement(DELETE);){
      ...
      logger.error("ERROR: Deleting prepared statement", e);
      throw new RuntimeException(e);
    }
  }
  ...
  public List<Customer> findAllSorted(int limit){
    ...
    try(PreparedStatement statement = this.connection.prepareStatement(GET_ALL_LMT);){
      ...
      logger.error("ERROR: find all sorted", e);
      throw new RuntimeException(e);
    }
    return customers;
  }
  ...
  public List<Customer> findAllPaged(int limit, int pageNumber) {
    ...
    try (PreparedStatement statement = this.connection.prepareStatement(GET_ALL_PAGED);) {
      ...
      logger.error("ERROR: find all paged", e);
      throw new RuntimeException(e);
    }
    return customers;
  }
